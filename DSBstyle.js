...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (openSettingsBtn) {
        ...
        // UI-only: decide karta hai kaunsa section dikhana hai (password
        // fields vs Google notice), phir modal khol deta hai. Business
        // Name/Website fill karne wala Firebase read DSB.js me alag
        // listener hai — newClientModal jaisa hi split.
